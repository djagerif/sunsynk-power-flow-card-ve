        ...
        <div class="container card">
          ...
          <svg viewBox="-0.5 -0.5 457 383" preserveAspectRatio="xMidYMid meet" height="${panel === 'no' ? `${height}` : '100%'}" width="100%" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
            ...
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.day_pv_energy_108)}>
              <text id="daily_solar_value" x="43.5" y="15" class="st10 left-align" display="${solar_showdaily === 'no' || config.show_solar === 'no' || remaining_solar != 'false' ? 'none' : ''}" fill="${solar_colour}" >${isNaN(parseFloat(stateObj4.state)) ? '0' : `${parseFloat(stateObj4.state).toFixed(1)}`} kWh</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.day_pv_energy_108)}>
              <text id="remaining_solar_value" x="43.5" y="15" class="st10 left-align" display="${solar_showdaily === 'no' || config.show_solar === 'no' || remaining_solar === 'false' ? 'none' : ''}" fill="${solar_colour}" >${isNaN(parseFloat(stateObj4.state)) ? '0' : `${parseFloat(stateObj4.state).toFixed(1)}`} kWh / ${remaining_solar} kWh</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.day_load_energy_84)}>
              <text id="daily_load_value_aux" x="${additional_aux_load === 'two' ? '238' : '306'}" y="83" class="st10 left-align" display="${load_showdaily === 'no' || show_aux === 'no' ? 'none' : ''}" fill="${load_colour}" >${parseFloat(stateObj2.state).toFixed(1) ? parseFloat(stateObj2.state).toFixed(1) : '0'} kWh</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.day_load_energy_84)}>
            ...
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.day_battery_charge_70)}>
              <text id="daily_bat_charge_value" x="4.5" y="237" class= "st10 left-align" display="${battery_showdaily === 'no' ? 'none' : ''}" fill="${battery_colour}">${isNaN(parseFloat(stateObj1.state)) ? '0' : `${parseFloat(stateObj1.state).toFixed(1)}`} kWh</text>
            </a> 
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.day_battery_discharge_71)}>
              <text id="daily_bat_discharge_value" x="4.5" y="271" class="st10 left-align" display="${battery_showdaily === 'no' ? 'none' : ''}" fill="${battery_colour}" >${isNaN(parseFloat(stateObj.state)) ? '0' : `${parseFloat(stateObj.state).toFixed(1)}`} kWh</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.day_grid_import_76)}>
              <text id="daily_grid_buy_value" x="${grid_show_noness === 'no' ? '311' : '347'}" y="${grid_show_noness === 'no' ? '354' : '239'}" class="st10 left-align" display="${grid_showdailybuy === 'no' ? 'none' : ''}" fill="${grid_colour}" >${isNaN(parseFloat(stateObj3.state)) ? '-.-' : `${parseFloat(stateObj3.state).toFixed(1)}`} kWh</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.day_grid_export_77)}>
              <text id="daily_grid_sell_value" x="${grid_show_noness === 'no' ? '311' : '347'}" y="${grid_show_noness === 'no' ? '323' : '209'}" class="st10 left-align" display="${grid_showdailysell === 'no' ? 'none' : ''}" fill="${grid_colour}" >${isNaN(parseFloat(stateObj33.state)) ? '-.-' : `${parseFloat(stateObj33.state).toFixed(1)}`} kWh</text>
            </a>
            ...
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.battery_power_190)}>
              <text id="battery_power_190" x="41" y="356" display="${config.entities.battery_power_190 === 'none' ? 'none' : ''}" fill=${battery_colour} class="${font === 'no' ? 'st14' : 'st4'} st8">${(battery_power) ? (battery_auto_scale ? yn(battery_power * -1,dp): (battery_power * -1) + ' W') : '0 W'} </text>
            </a>
      ...
      return html`
        ...
        <div class="container card">
          <svg viewBox="-0.5 ${config.show_solar === 'no' ? 145.33 : -0.5} 483 ${config.show_solar === 'no' ? 270.67 : 406}" preserveAspectRatio="xMidYMid meet" height="${panel === 'no' ? `${config.show_solar === 'no' ? '246px' : `${height}`}` : `${config.show_solar === 'no' ? '75%' : '100%'}`}" width="100%"  xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
            ...
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.day_battery_charge_70)}>
              <text id="daily_bat_charge_value" x="57.2" y="343" class= "st10 left-align" display="${battery_showdaily === 'no' ? 'none' : ''}" fill="${battery_colour}">${isNaN(parseFloat(stateObj1.state)) ? '0' : `${parseFloat(stateObj1.state).toFixed(1)}`} kWh</text>
            </a> 
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.day_pv_energy_108)}>
              <text id="daily_solar_value" x="180" y="26" class="st10 left-align" display="${solar_showdaily === 'no' || config.show_solar === 'no' || remaining_solar != 'false' ? 'none' : ''}" fill="${solar_colour}" >${isNaN(parseFloat(stateObj4.state)) ? '0' : `${parseFloat(stateObj4.state).toFixed(1)}`} kWh</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.day_pv_energy_108)}>
              <text id="remaining_solar_value" x="180" y="26" class="st10 left-align" display="${solar_showdaily === 'no' || config.show_solar === 'no' || remaining_solar === 'false' ? 'none' : ''}" fill="${solar_colour}" >${isNaN(parseFloat(stateObj4.state)) ? '0' : `${parseFloat(stateObj4.state).toFixed(1)}`} kWh / ${remaining_solar} kWh</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.day_battery_discharge_71)}>
              <text id="daily_bat_discharge_value" x="57.2" y="380.1" class="st10 left-align" display="${battery_showdaily === 'no' ? 'none' : ''}" fill="${battery_colour}" >${isNaN(parseFloat(stateObj.state)) ? '0' : `${parseFloat(stateObj.state).toFixed(1)}`} kWh</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.day_load_energy_84)}>
              <text id="daily_load_value" x="${additional_load === 'two' ? '365' : '415'}" y="${additional_load === 'two' ? '168' : '267.9'}" class="st10 left-align" display="${load_showdaily === 'no'  ? 'none' : ''}" fill="${load_colour}" >${isNaN(parseFloat(stateObj2.state)) ? '0' : `${parseFloat(stateObj2.state).toFixed(1)}`} kWh</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.day_grid_import_76)}>
              <text id="daily_grid_buy_value" x="5" y="267.9" class="st10 left-align" display="${grid_showdailybuy === 'no' ? 'none' : ''}" fill="${grid_colour}" >${isNaN(parseFloat(stateObj3.state)) ? '0' : `${parseFloat(stateObj3.state).toFixed(1)}`} kWh</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.day_grid_export_77)}>
              <text id="daily_grid_sell_value" x="5" y="165" class="st10 left-align" display="${grid_showdailysell === 'no' ? 'none' : ''}" fill="${grid_colour}" >${isNaN(parseFloat(stateObj33.state)) ? '0' : `${parseFloat(stateObj33.state).toFixed(1)}`} kWh</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.inverter_voltage_154)}>
            ...
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.battery_voltage_183)}>
              <text id="battery_voltage_183" x="173" y="346" display="${config.entities.battery_voltage_183 === 'none' || !config.entities.battery_voltage_183 ? 'none' : ''}" fill=${battery_colour} class="${font === 'no' ? 'st14' : 'st4'} st8">${battery_voltage} V</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.battery_soc_184)}>
            ...
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.battery_current_191)}>
            <text id="battery_current_191" x="173" y="365.3" display="${config.entities.battery_current_191 === 'none' ? 'none' : ''}" fill=${battery_colour} class="${font === 'no' ? 'st14' : 'st4'} st8">${stateObj35.state ? stateObj35.state : '0'} A</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.grid_ct_power_172)}>
